...
```
### Numba — это мощная библиотека для Python, которая позволяет значительно ускорять выполнение кода за счёт Just-In-Time (JIT) компиляции. Она особенно полезна для вычислений с большими массивами данных и научных вычислений.
````
    from numba import jit
    import time

    # Сложная функция: сумма квадратов
    @jit  # ускоряет выполнение
    def slow_function(n):
        total = 0
        for i in range(n):
            total += i ** 2
...
### Вопросы
````
Объясните разницу между списком (list), кортежем (tuple) и множеством (set). Когда использовать каждый из них?
Что такое list comprehension? Приведите пример его использования и объясните, когда он предпочтительнее цикла.
Как работают изменяемые (mutable) и неизменяемые (immutable) типы данных в Python? Приведите примеры.
Что такое None в Python? Как правильно проверять значение на None?
Объясните, как работает управление памятью в Python (например, сборщик мусора).
Функции и модули
Что такое *args и **kwargs? Приведите пример их использования.
Как работают декораторы в Python? Напишите простой декоратор для логирования времени выполнения функции.
Объясните разницу между import module, from module import * и import module as alias. Какие есть риски при использовании from module import *?
Что такое лямбда-функции? Когда их стоит использовать, а когда нет?
Как организовать модули и пакеты в Python? Объясните структуру __init__.py.
Структуры данных
Как реализовать собственную структуру данных, например, стек или очередь, используя встроенные типы Python?
Чем отличается collections.deque от обычного списка? В каких случаях стоит использовать deque?
Как работает словарь (dict) в Python? Объясните, что такое хэшируемость (hashability).
Как эффективно работать с большими списками данных в Python? Какие оптимизации можно применить?
Что такое Counter из модуля collections? Приведите пример его использования.
Объектно-ориентированное программирование (ООП)
Объясните основные принципы ООП (наследование, инкапсуляция, полиморфизм) на примерах в Python.
Что такое метаклассы в Python? Приведите пример их использования.
Как работают свойства (properties) в Python? Напишите пример с использованием @property.
Что такое магические методы (например, __init__, __str__, __len__)? Приведите пример их реализации.
Как реализовать собственный контекстный менеджер с использованием __enter__ и __exit__?
Работа с исключениями
Как правильно обрабатывать исключения в Python? Объясните разницу между try-except и try-finally.
Как создать собственное исключение? Приведите пример.
Что такое else и finally в конструкции try-except? Когда их стоит использовать?
Как обрабатывать несколько исключений в одном блоке except?
Многопоточность и асинхронное программирование
Чем отличается многопоточность от многопроцессности в Python? Что такое GIL и как он влияет на производительность?
Как использовать модуль threading для выполнения задач в нескольких потоках? Приведите пример.
Объясните, как работает асинхронное программирование в Python с использованием asyncio. Напишите пример с async и await.
Что такое concurrent.futures? Как использовать ThreadPoolExecutor и ProcessPoolExecutor?
Как обрабатывать ошибки в асинхронных функциях?
Работа с файлами и данными
Как читать и записывать файлы в Python? Чем отличаются режимы r, w, a, rb, wb?
Как работать с JSON в Python? Приведите пример сериализации и десериализации данных.
Как использовать модуль csv для чтения и записи CSV-файлов?
Как обрабатывать большие файлы построчно, чтобы не загружать их целиком в память?
Стандартная библиотека и инструменты
Как использовать модуль datetime для работы с датами и временем? Приведите пример.
Что такое itertools? Приведите пример использования chain или permutations.
Как работает модуль logging? Как настроить логирование в Python-приложении?
Как использовать модуль os для работы с файловой системой? Приведите пример.
Что такое argparse? Как создать CLI-приложение с использованием этого модуля?
Производительность и оптимизация
Как профилировать Python-код? Какие инструменты вы используете (например, cProfile, timeit)?
Как оптимизировать работу со списками или словарями для обработки больших данных?
Что такое генераторы в Python? Как они помогают экономить память? Напишите пример генератора.
Как использовать numba или Cython для ускорения Python-кода?
Тестирование
Как организовать тестирование Python-кода? Какие библиотеки вы используете (unittest, pytest)?
Что такое mock-объекты? Как использовать библиотеку unittest.mock для тестирования?
Как тестировать функции, работающие с внешними API или базами данных?
Безопасность и лучшие практики
Как защитить Python-приложение от уязвимостей, таких как инъекции или переполнение буфера?
Что такое PEP 8? Какие другие PEP вы считаете важными для разработки на Python?
Как правильно использовать виртуальные окружения (venv, virtualenv) и зачем они нужны?
Как обрабатывать зависимости в Python-проекте? Чем отличается requirements.txt от Pipfile?
Практические задачи
Напишите функцию, которая находит все анаграммы в списке строк.
Реализуйте декоратор, который кэширует результаты функции для повторных вызовов.
Напишите программу, которая читает CSV-файл и группирует данные по заданному столбцу.
Реализуйте простой HTTP-сервер с использованием http.server для обработки GET-запросов.
Напишите асинхронную функцию для параллельной загрузки данных с нескольких URL с использованием aiohttp.
Что такое веб-скрейпинг? Какие основные задачи можно решать с его помощью?
Какие библиотеки Python вы использовали для веб-скрейпинга? Чем отличаются BeautifulSoup, Scrapy и Selenium?
Как работает HTTP-запрос? Объясните разницу между GET и POST запросами.
Что такое User-Agent, и почему важно его настраивать при скрейпинге?
Как обработать HTML-страницу с помощью BeautifulSoup? Напишите пример парсинга заголовков <h1>.
Работа с библиотеками
Как использовать библиотеку requests для отправки HTTP-запросов? Приведите пример.
Напишите пример кода для парсинга таблицы с сайта с использованием BeautifulSoup.
Как настроить Scrapy для скрейпинга сайта? Опишите структуру проекта Scrapy.
Как использовать Selenium для скрейпинга динамических страниц (например, с JavaScript)? Напишите пример.
Чем отличается статический скрейпинг от динамического? Когда стоит использовать Selenium вместо BeautifulSoup?
Обработка данных
Как извлечь данные из JSON-ответа API? Напишите пример с использованием requests.
Как обработать данные, содержащие HTML-теги, и преобразовать их в чистый текст?
Как извлечь данные из таблиц или списков на сайте? Приведите пример с BeautifulSoup или Scrapy.
Как работать с кодировками страниц (например, UTF-8, Windows-1251) при скрейпинге?
Как сохранить скрейпленные данные в CSV или JSON? Напишите пример.
Асинхронный скрейпинг
Как использовать aiohttp для асинхронного скрейпинга? Напишите пример кода.
Какие преимущества даёт асинхронный скрейпинг по сравнению с синхронным?
Как настроить Scrapy для асинхронной обработки большого количества страниц?
Как избежать блокировки при массовом скрейпинге? Какие библиотеки или подходы помогают?
Как использовать пул прокси для обхода ограничений при скрейпинге?
Обход ограничений и защита от блокировок
Как обойти CAPTCHA при скрейпинге? Какие сервисы или методы вы использовали?
Как настроить задержки между запросами, чтобы избежать блокировки сервера?
Что такое headless-браузеры? Как использовать их с Selenium для скрейпинга?
Как обойти защиту от скрейпинга, основанную на JavaScript-обфускации?
Как использовать ротацию User-Agent или IP-адресов для предотвращения блокировок?
Этика и юридические аспекты
Какие юридические аспекты нужно учитывать при веб-скрейпинге? Что такое robots.txt?
Как проверить, разрешает ли сайт скрейпинг? Как интерпретировать файл robots.txt?
Какие этические принципы следует соблюдать при сборе данных с веб-сайтов?
Как минимизировать нагрузку на сервер сайта при скрейпинге?
Какие риски связаны с нарушением условий использования сайта при скрейпинге?
Интеграция и автоматизация
Как интегрировать веб-скрейпинг с FastAPI для создания API с данными? Напишите пример.
Как настроить периодический скрейпинг с использованием schedule или Celery?
Как использовать Docker для контейнеризации скрейпинг-приложения? Напишите пример Dockerfile.
Как интегрировать скрейпинг с базой данных (например, PostgreSQL) для хранения данных?
Как настроить мониторинг и логирование для скрейпинг-приложения?
Продвинутые темы
Как скрейпить данные с сайтов, использующих SPA (Single Page Applications, например, React или Angular)?
Как использовать Scrapy для скрейпинга нескольких сайтов одновременно? Опишите подход.
Как реализовать пагинацию при скрейпинге (например, переход по страницам с результатами)?
Как извлечь данные из PDF-файлов, загруженных с сайта? Какие библиотеки вы используете?
Как использовать регулярные выражения для извлечения данных из HTML? Приведите пример.
Отладка и тестирование
Как отладить проблемы с парсингом, если структура HTML изменилась?
Как проверить, что скрейпинг возвращает корректные данные? Какие тесты вы пишете?
Как обрабатывать ошибки HTTP (например, 403, 429) при скрейпинге?
Как протестировать скрейпинг-приложение с помощью pytest? Приведите пример.
Как выявить, что сайт блокирует ваш скрейпер, и какие шаги предпринять?
Практические задачи
Напишите код для скрейпинга списка заголовков новостей с новостного сайта с использованием BeautifulSoup.
Реализуйте Scrapy-паук для сбора цен и названий товаров с интернет-магазина.
Создайте скрипт с Selenium для авторизации на сайте и скрейпинга данных из личного кабинета.
Напишите асинхронный скрейпер с aiohttp для сбора данных с 10 страниц сайта.
Реализуйте API с FastAPI, которое скрейпит данные с сайта и возвращает их в формате JSON.
````